...
RPC.connect()
RPC.update(state='MassDmer', details='made by Slimes#0111', large_image='dsfdsfdf', small_image = "dsfdsfdf", start=time.time(), large_text="v1.0.0")
...
token = "ODQ1NzEwNTE0NTk2MjE2ODUz.YQCEEQ.v8Dr57oaj5iZMTSmruRdMlxQKfQ"
